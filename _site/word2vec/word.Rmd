...
<title>Visualizing Word2Vec word vectors using the superheat R package - Superheat</title>
<meta property="og:title" content="Visualizing Word2Vec word vectors using the superheat R package" />
<link rel="canonical" href="http://localhost:4000/word2vec/word.Rmd" />
<meta property="og:url" content="http://localhost:4000/word2vec/word.Rmd" />
<meta property="og:site_name" content="Superheat" />
<script type="application/ld+json">
{"@context": "http://schema.org",
"@type": "WebPage",
"headline": "Visualizing Word2Vec word vectors using the superheat R package",
"url": "http://localhost:4000/word2vec/word.Rmd"}</script>
<!-- End Jekyll SEO tag -->
...
<div class="page">
  <h1 class="page-title">Visualizing Word2Vec word vectors using the superheat R package</h1>
